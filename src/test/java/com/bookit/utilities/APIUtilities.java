...
public class APIUtilities {
    ...
    // We authenticate, retrieve token every time, no reduce duplication in this APIUtilities class we will have
    ...
    // but token like bearer token is in Header and it will expire after some time"(dear clever Sofiya)


    // if there were to many api calls => we would create separate api functions package;
// based on categories everything related user in user class teacher in teacher class..
    ...
    public static int getUserID(String email, String password) {
        ...
        return -1;  ////if user does not exist -response of this method will be -1
    }
    ...
    /**
     * Use this method to add new team to the system
     *
    ...
    /**
     * Use this metho before creating new user
